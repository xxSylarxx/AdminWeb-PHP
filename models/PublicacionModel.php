...
class PublicacionModel extends DataBase
{
    ...
    public function listarPublicaciones($init, $categoria = '%')
    {
        try {
            $query = $this->bd->from('publicacion pb')
                ...
                ->select(null)->select('pb.idpub, pb.idcatg, ct.nombre as categoria, pb.titulo, pb.tagname, pb.portada, pb.fecpub, pb.visible')
    ...
    public function listarPublicacionesWeb($init, $limt, $categoria = '%')
    {
        try {
            $query = $this->bd->from('publicacion pb')
                ->innerJoin('categorias ct ON ct.idcatg = pb.idcatg')
                ->select(null)->select('pb.idpub, pb.idcatg, ct.nombre as categoria, pb.titulo, pb.tagname, pb.portada, pb.detalle, pb.fecpub, pb.visible')
    ...
    public function listarPaginacionPub($cateId, $total, $pag)
    {
        $list = '';
    ...
    public function listPaginacionPubWeb($cateId, $total, $pag, $url)
    {
        $list = '';
