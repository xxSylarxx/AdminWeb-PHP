...
$dataEmpresa = $objEmpresa->listarEmpresa()[1];
$dataCategorias = $objPublicacion->listarCategoriasWeb();
$listPublicaciones = $objPublicacion->listarPublicacionesWeb(0, 5);
$listPublicacionesAll = $objPublicacion->listarPublicacionesWeb(0, 45);
if (isset($URI[1])) {
    if ($URI[1] == 'preview') {
                    ...
                    <div class="card-body">
                        ...
                        foreach ($dataCategorias as $value) : ?>
                            <div class="d-flex" style="font-size: 14.5px;">
                                <a href="/publicaciones/<?= $value['filtro'] ?>"><?= $value['nombre'] ?> (<?= $objPublicacion->totalPublicaciones($value['idcatg']) ?>)</a>
                            </div>
                        <?php endforeach; ?>
