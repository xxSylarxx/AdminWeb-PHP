...
if ($filter !== 'all') {
    $dataCategoria = $objPublicaciones->buscarCategoria($URI[1], false);
    $idCateg = $dataCategoria['idcatg'];
    $nameCategoria = $dataCategoria['nombre'];
    $dataPublicaciones = $objPublicaciones->listarPublicacionesWeb($initPub, PUB_MAX_WEB, $idCateg);
} else {
    $idCateg = '%';
    $nameCategoria = 'All';
    $dataPublicaciones = $objPublicaciones->listarPublicacionesWeb($initPub, PUB_MAX_WEB, $idCateg);
        ...
        <div class="row pt-4">
            <div class="col-lg pt-3">
                <ul class="pagination justify-content-center">
                    <?= $objPublicaciones->listPaginacionPubWeb($filter, $total, $pagina, "/publicaciones/"); ?>
                </ul>
            </div>
        </div>
    </div>
