...
$dataBanner = $objBanner->listarBannerWeb();
$dataEmpresa = $objEmpresa->listarEmpresa()[1];
$dataModal = $objModal->obtener();
$dataPublicaciones = $objPublicaciones->listarPublicacionesWeb(0, 3);
?>
<!DOCTYPE html>
<html lang="es">
                ...
                <div class="modal-content animate__animated <?= $dataModal['animation'] ?>" style="<?= ($dataModal['margen'] == 'N' && $dataModal['header'] == 'N') ? 'background: transparent; border: none;' : null ?>">
                    <?php if ($dataModal['header'] == 'S') { ?>
                        <div class="modal-header">
                            <h5 class="modal-title"><?= $dataModal['titulo'] ?></h5>
